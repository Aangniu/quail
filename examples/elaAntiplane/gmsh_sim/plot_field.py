...
fname = folder+"Data_drFine_12.pkl"
...
plot.plot_solution(mesh, physics, solver, comp, plot_numerical=True,
		...
		show_elem_IDs=False)
plot.save_figure(file_name='dr_epzx', file_type='pdf', crop_level=2)
# plot.show_plot()
...
plot.plot_solution(mesh, physics, solver, comp, plot_numerical=True,
		...
		legend_label="DG", include_mesh=True, regular_2D=True,
		show_elem_IDs=False)
plot.save_figure(file_name='dr_vz', file_type='pdf', crop_level=2)
# plot.show_plot()